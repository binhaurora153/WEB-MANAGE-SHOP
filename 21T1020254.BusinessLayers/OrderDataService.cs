...
namespace _21T1020254.BusinessLayers
{
    public static class OrderDataService
    {
        ...
        /// <summary>
        /// Cập nhật thông tin nhân viên phụ trách cho đơn hàng
        /// </summary>
        public static bool UpdateOrderEmployee(int orderID, int employeeID, string employeeName)
        {
            Order? data = orderDB.Get(orderID);
            if (data == null)
                return false;
        ...
        /// Duyệt chấp nhận đơn hàng
        /// </summary>
        public static bool AcceptOrder(int orderID, int employeeID, string employeeName)
        {
            Order? data = orderDB.Get(orderID);
            if (data == null)
                return false;
            ...
            if (data.Status == Constants.ORDER_INIT)
            {
                // Cập nhật thông tin nhân viên phụ trách nếu chưa có
